...
#Height  = int(cap.get(cv2.CAP_PROP_FRAME_Width)) no
...
#width  = int(cap.get(cv2.CAP_PROP_FRAME_HEIGHT)) 
#height  = int(cap.get(cv2.CAP_PROP_FRAME_HEIGHT)) no
...
def countFingers(image, hand_landmarks, handNo=0):
    ...
    if hand_landmarks:
        ...
        #finger_tip_x = (landmarks[8].y)*height no

        #finger_tip_x = (landmarks[8].x)*height
        #finger_tip_y = (landmarks[8].y)*width no
